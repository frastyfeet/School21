...
START_TEST(test_less_equal_values_with_different_scale) {
  s21_decimal a = {{1000, 0, 0, 0x00030000}};  // 1.000 (scale 3)
...
START_TEST(test_less_negative_and_positive_with_scale) {
  s21_decimal a = {{100, 0, 0, 0x00020000}};  // 1.00 (scale 2)
  s21_decimal b = {{1, 0, 0, 0x80000000}};    // -1
  ck_assert_int_eq(s21_is_less(a, b), 0);
}
END_TEST
...
START_TEST(test_less_with_scale_larger_value) {
  s21_decimal a = {{1, 0, 0, 0x00010000}};  // 0.1 (scale 1)
  s21_decimal b = {{2, 0, 0, 0}};           // 2
  ck_assert_int_eq(s21_is_less(a, b), 1);
}
END_TEST
...
START_TEST(test_less_with_scale_smaller_value) {
  s21_decimal a = {{20, 0, 0, 0x00010000}};  // 2.0 (scale 1)
  s21_decimal b = {{1, 0, 0, 0}};            // 1
  ck_assert_int_eq(s21_is_less(a, b), 0);
}
END_TEST
...
START_TEST(test_less_with_scale_equal_value) {
  s21_decimal a = {{500, 0, 0, 0x00020000}};  // 5.00 (scale 2)
  s21_decimal b = {{50, 0, 0, 0x00010000}};   // 5.0 (scale 1)
  ck_assert_int_eq(s21_is_less(a, b), 0);
}
END_TEST
