...
START_TEST(test_tc11) { test_tc11_executed = 1; }
END_TEST

START_TEST(test_tc12) { test_tc12_executed = 1; }
END_TEST

START_TEST(test_tc21) { test_tc21_executed = 1; }
END_TEST
...
static void selective_teardown(void) { srunner_free(sr); }
...
START_TEST(test_srunner_run_run_all) {
  ...
  srunner_run(sr, NULL, /* NULL tsuite name.  */
...
START_TEST(test_srunner_run_suite) {
  ...
  srunner_run(sr, "suite1", NULL, /* NULL tcase name.  */
              CK_VERBOSE);

  ck_assert_msg(test_tc11_executed && test_tc12_executed && !test_tc21_executed,
...
START_TEST(test_srunner_run_no_suite) {
  ...
  srunner_run(sr, "non-existing-suite", NULL, /* NULL tcase name. */
              CK_VERBOSE);

  ck_assert_msg(
      !(test_tc11_executed || test_tc12_executed || test_tc21_executed),
...
START_TEST(test_srunner_run_tcase) {
  /* This test makes the srunner_run function to run an specific
     existing test case.  */
  srunner_run(sr, NULL, /* NULL suite name.  */
              "tcase12", CK_VERBOSE);
...
START_TEST(test_srunner_no_tcase) {
  /* This test makes the srunner_run function to run a non-existant
     test case.  */
  srunner_run(sr, NULL, /* NULL suite name.  */
              "non-existant-test-case", CK_VERBOSE);
