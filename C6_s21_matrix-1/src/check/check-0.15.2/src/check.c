...
void _tcase_add_test(TCase *tc, const TTest *ttest, int _signal,
...
const char *tcase_name(void) { return current_test_name; }
...
static int non_pass(enum test_result val) { return val != CK_PASS; }
